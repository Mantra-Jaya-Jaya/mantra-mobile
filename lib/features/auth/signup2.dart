...
class _Signup2State extends State<Signup2> {
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Row(
                              ...
                              children: [
                                _buildStepItem(Icons.check, "Create Account", true),
                                Container(width: 50, height: 1, color: const Color(0xFFB45309)),
                                _buildStepItem(null, "Fill Your Identity", true, number: "2"),
                              ],
                            ),
                            const SizedBox(height: 40),
                            _buildTextField(controller: _namaController, label: 'Nama', hint: 'Nama Lengkap'),
                            const SizedBox(height: 20),
                            _buildTextField(controller: _alamatController, label: 'Alamat', hint: 'Alamat Lengkap', maxLines: 3),
                            const SizedBox(height: 20),
                            _buildTextField(controller: _telpController, label: 'Nomor Telepon', hint: '08xxxx'),
                            const SizedBox(height: 30),
                            Row(
                              children: [
                                Expanded(
                                  child: OutlinedButton(
                                    ...
                                    child: const Text('Back', style: TextStyle(color: Color(0xFFB45309), fontWeight: FontWeight.bold)),
                                  ),
                                ),
                                ...
                                Expanded(
                                  child: ElevatedButton(
                                    onPressed: _isFormValid ? () {
                                      _showSuccessDialog(context); // Panggil fungsi dialog
                                    } : null,
  ...
  Widget _buildStepItem(IconData? icon, String label, bool isActive, {String? number}) {
    return Column(
      children: [
        CircleAvatar(
          radius: 18,
        ...
        Text(label, style: const TextStyle(fontSize: 11, fontWeight: FontWeight.bold, color: Color(0xFFB45309))),
      ],
    );
  }
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                const Icon(Icons.person_outline, size: 60, color: Color(0xFFB45309)),
